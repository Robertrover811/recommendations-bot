...
async def on_ready():
    ...
    await bot.change_presence(activity=discord.Game('My Prefix is $- #SendTimtothemoon https://youtube.com/watch?v=ENLrk1q1l3M'))
...
async def commands(ctx):
    commands = [
        ...
        "**$rolldice**: Rolls some dice for you (or flips a coin) so you can decide which recommendation:tm: to choose! Format with the amount of dice you want to roll, then how many sides they have.",
        "**$help**: Displays this menu",
        "**$info**: Displays basic info about this bot"
    ]
...
async def message(ctx):
    embedVar = discord.Embed(
        ...
        description=
        "Recommendations bot first started development in July 2020. This bot was made by Robertrover811#5049- DM him if you have any issues. You can find him on Github at https://github.com/Robertrover811",
        color=0x000053)
    await ctx.send(embed=embedVar)
